            ...
            <div class="row">
                <div class="col-xxl">
                    <div class="card mb-4">
                        ...
                        <form class="card-body" action="{{ route('cashbook.store') }}" method="POST"
                            ...
                            <div class="row mb-3">
                                <div class="col-md-4">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control @error('cash_out') is-invalid @enderror"
                                ...
                                <div class="col-md-4">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control @error('bank_out') is-invalid @enderror"
