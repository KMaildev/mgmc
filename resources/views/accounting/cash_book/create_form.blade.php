...
<form action="{{ route('cashbook.store') }}" method="POST" autocomplete="off" id="create-form">
    ...
    <tr>
        ...
        <td>
            <input type="text" class="form-control-custom input-text-center  @error('cash_in') is-invalid @enderror"
        ...
        <td>
            <input type="text" class="form-control-custom input-text-center @error('cash_out') is-invalid @enderror"
        ...
        <td>
            <input type="text" class="form-control-custom input-text-center @error('bank_in') is-invalid @enderror"
        ...
        <td>
            <input type="text" class="form-control-custom input-text-center @error('bank_out') is-invalid @enderror"
