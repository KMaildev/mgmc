<form action="{{ route('sales_journal.store') }}" method="POST" autocomplete="off" id="create-form">
    @csrf
    <tr>
        <td></td>
        ...
        <td>
            <input type="text"
                ...
                name="sales_journal_date" style="width: 100%" />
        ...
        <td>
            <input type="text"
                ...
                name="debited" style="width: 100%" id="Debited" value="0" />
            @error('debited')
                <div class="invalid-feedback"> {{ $message }} </div>
            @enderror
        </td>
...
@section('script')
    {!! JsValidator::formRequest('App\Http\Requests\StoreSalesJournal', '#create-form') !!}
    <script>
